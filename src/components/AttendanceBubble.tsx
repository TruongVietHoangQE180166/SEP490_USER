  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="group fixed bottom-28 right-4 md:right-8 z-[9999] flex items-center justify-center w-16 h-16 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/40 ring-4 ring-primary/20 cursor-pointer pointer-events-auto"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-48 right-4 md:right-8 z-[9999] w-[calc(100%-2rem)] max-w-[calc(100vw-2rem)] md:w-96 bg-background border border-border rounded-2xl shadow-2xl overflow-hidden pointer-events-auto"
          >
            {/* Header */}

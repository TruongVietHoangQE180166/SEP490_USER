  ...
  "toast-base fixed z-[99999999] pointer-events-auto flex w-[calc(100%-2rem)] max-w-sm min-h-20 items-center justify-between space-x-4 rounded-lg p-4 pr-8 shadow-lg",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-accent text-accent-foreground border border-accent",
        warning: "bg-background text-foreground border border-amber-500", 
        info: "bg-secondary text-secondary-foreground border border-secondary",
        loading: "bg-muted text-muted-foreground border border-muted",
      },
      position: {
...
const ToastIcons = {
  ...
  destructive: (
    <AlertCircle className="w-5 h-5 text-current flex-shrink-0" />
  ),
  warning: (
    <AlertCircle className="w-5 h-5 text-current flex-shrink-0" />
  ),
  info: (
    <Info className="w-5 h-5 text-current flex-shrink-0" />
  ),
  loading: (
    <div className="w-5 h-5 flex-shrink-0 relative">
      <motion.div
        className="absolute inset-0 bg-current shadow-[0_0_4px_currentColor] opacity-75"
    ...
    >
      <div className="flex items-start space-x-3 w-full">
        ...
        <div className="flex-1">
          ...
          {description && (
            <div className="text-xs opacity-70 break-words mt-1">
              {description}
            </div>
          )}
        </div>
